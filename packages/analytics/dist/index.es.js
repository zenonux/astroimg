...
X.prototype.init = function(e, t) {
  ...
  if (this.page_hidden_status !== !0) {
    let e = this.getPageLeaveProperties();
    this.page_show_status === !1 && delete e.event_duration, this.page_show_status = !1, this.page_hidden_status = !0, // PageLeave 不上报
    ...
    this.refreshPageEndTimer(), this.delHeartBeatData();
  }
...
const Mu = {
  mounted(e, t) {
    const r = Array.isArray(t.value) ? t.value : [t.value], i = Ju(), n = [];
...
function qu(e) {
  return Ar.use("PageLeave", {
    ...
    urlPropertyMap: e.pageView.urlPropertyMap,
    isCollectUrl: e.pageView.isCollectUrl
  }), Ar.init({ ...e.sensorsConfig }), gr = new Hu(Ar, e), gr;
}
function Ju() {
  if (!gr)
