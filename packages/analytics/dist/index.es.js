...
X.prototype.init = function(e, t) {
  if (e) {
    if (console.log(8888), this.sd = e, this._ = this.sd._, t) {
      this.option = t;
  ...
  this.start_time = +/* @__PURE__ */ new Date(), document.hidden ? this.page_show_status = !1 : this.page_show_status = !0, this.url = location.href, this.isCollectUrl(this.url) && this.sd.track(this.option.event_name_view, Object.assign(e, this.option.urlPropertyMap(this.url))), this.title = document.title;
...
s.DEFAULT_SEND_TYPE = "image", (function() {
  ...
  var a = function l(u, p) {
    ...
    let b = u.Number || t.Number, w = u.String || t.String, L = u.Object || t.Object, P = u.Date || t.Date, Se = u.SyntaxError || t.SyntaxError, J = u.TypeError || t.TypeError, Te = u.Math || t.Math, at = u.JSON || t.JSON;
    if (typeof at == "object" && at)
      return p.stringify = at.stringify, p.parse = at.parse, p.runInContext = l, p;
    let ge, ci = L.prototype, Ee = ci.toString, Wt = ci.hasOwnProperty;
    function Ye(_e, re) {
      try {
        _e();
      } catch {
    ...
    let Le = new P(-3509827334573292);
    function Z(_e) {
      if (Z[_e] != null)
        return Z[_e];
      let re;
      if (_e == "bug-string-char-index")
        re = !1;
      else if (_e == "json")
        re = Z("json-stringify") && Z("date-serialization") && Z("json-parse");
      else if (_e == "date-serialization") {
        if (re = Z("json-stringify") && Le) {
          var _ = p.stringify;
          Ye(() => {
            re = _(new P(-864e13)) == '"-271821-04-20T00:00:00.000Z"' && _(new P(864e13)) == '"+275760-09-13T00:00:00.000Z"' && _(new P(-621987552e5)) == '"-000001-01-01T00:00:00.000Z"' && _(new P(-1)) == '"1969-12-31T23:59:59.999Z"';
          });
        }
      } else {
        let H, De = '{"a":[1,true,false,null,"\\u0000\\b\\n\\f\\r\\t"]}';
        if (_e == "json-stringify") {
          let x = typeof (_ = p.stringify) == "function";
          x && ((H = function() {
            return 1;
          }).toJSON = H, Ye(
            () => {
              x = _(0) === "0" && _(new b()) === "0" && _(new w()) == '""' && _(Ee) === ge && _(ge) === ge && _() === ge && _(H) === "1" && _([H]) == "[1]" && _([ge]) == "[null]" && _(null) == "null" && _([ge, Ee, null]) == "[null,null,null]" && _({ a: [H, !0, !1, null, `\0\b
\f\r	`] }) == De && _(null, H) === "1" && _([1, 2], null, 1) == `[
 1,
 2
]`;
            },
        ...
        if (_e == "json-parse") {
          let x, E = p.parse;
          typeof E == "function" && Ye(
            () => {
              E("0") !== 0 || E(!1) || (H = E(De), (x = H.a.length == 5 && H.a[0] === 1) && (Ye(() => {
                x = !E('"	"');
              }), x && Ye(() => {
                x = E("01") !== 1;
              }), x && Ye(() => {
    ...
    if (Ye(() => {
      ...
      let _e = Z("bug-string-char-index"), re = function(_, H) {
        ...
        return De = x = null, N ? re = function(U, O) {
          ...
          let f, S, C = Ee.call(U) == "[object Function]", R = !C && typeof U.constructor != "function" && e[typeof U.hasOwnProperty] && U.hasOwnProperty || Wt;
          for (f in U)
            C && f == "prototype" || !R.call(U, f) || O(f);
          for (S = x.length; f = x[--S]; ) R.call(U, f) && O(f);
        }), re(_, H);
      };
...
${yr}}` : `{${ce.join(",")}}` : "{}";
          ...
          p.stringify = function(O, f, S) {
            let C, R, v, y;
            if (e[typeof f] && f) {
              if ((y = Ee.call(f)) == "[object Function]")
                R = f;
...
`,
          ...
          for (var f, S, C, R, v, y = H, F = y.length; _ < F; )
            switch (v = y.charCodeAt(_)) {
              ...
              case 58:
              case 44:
                return f = _e ? y.charAt(_) : y[_], _++, f;
              case 34:
                for (f = "@", _++; _ < F; )
                  if ((v = y.charCodeAt(_)) < 32)
                    E();
                  else if (v == 92)
                    switch (v = y.charCodeAt(++_)) {
                      case 92:
                      ...
                      case 117:
                        for (S = ++_, C = _ + 4; _ < C; _++)
                          (v = y.charCodeAt(_)) >= 48 && v <= 57 || v >= 97 && v <= 102 || v >= 65 && v <= 70 || E();
                        f += De(`0x${y.slice(S, _)}`);
                        break;
                      default:
                        E();
                    ...
                    if (v == 34)
                      break;
                    for (v = y.charCodeAt(_), S = _; v >= 32 && v != 92 && v != 34; )
                      v = y.charCodeAt(++_);
                    f += y.slice(S, _);
                  }
                if (y.charCodeAt(_) == 34)
                  return _++, f;
                E();
              default:
                if (S = _, v == 45 && (R = !0, v = y.charCodeAt(++_)), v >= 48 && v <= 57) {
                  for (v == 48 && (v = y.charCodeAt(_ + 1)) >= 48 && v <= 57 && E(), R = !1; _ < F && (v = y.charCodeAt(_)) >= 48 && v <= 57; _++) ;
                  if (y.charCodeAt(_) == 46) {
                    for (C = ++_; C < F && !((v = y.charCodeAt(C)) < 48 || v > 57); C++) ;
                    C == _ && E(), _ = C;
                  }
                  if ((v = y.charCodeAt(_)) == 101 || v == 69) {
                    for ((v = y.charCodeAt(++_)) != 43 && v != 45 || _++, C = _; C < F && !((v = y.charCodeAt(C)) < 48 || v > 57); C++) ;
                    C == _ && E(), _ = C;
                  }
                  return +y.slice(S, _);
                }
                R && E();
                var fe = y.slice(_, _ + 4);
                if (fe == "true")
                  return _ += 4, !0;
                if (fe == "fals" && y.charCodeAt(_ + 4) == 101)
                  return _ += 5, !1;
                if (fe == "null")
                  return _ += 4, null;
                E();
          ...
          let R = di(f, S, C);
          R === ge ? delete f[S] : f[S] = R;
        };
        var di = function(f, S, C) {
          let R, v = f[S];
          if (typeof v == "object" && v)
            if (Ee.call(v) == "[object Array]")
              for (R = v.length; R--; ) O(Ee, re, v);
            else
              re(v, (y) => {
                O(v, y, C);
              });
...
let te = {
  ...
  log() {
    (_i || console && console.log || function() {
    }).apply(
      null,
      arguments
    );
...
function Ir(e) {
  return typeof e == "function" || !(!e || typeof e != "object") && Ir(e.listener);
}
function Pe() {
  this._events = {};
}
...
function sr(e) {
  ...
  for (var t = ba(), r = e.substring(1).split("&"), i = 0; i < r.length; i++) {
    ...
    if (n !== -1) {
      ...
      a = Ve(a), l = Ve(l), a !== "__proto__" && a !== "constructor" && a !== "prototype" && (t[a] = l);
    }
  }
  return t;
}
...
function Vr(e) {
  ...
  return t.prototype.setUrl = function(r) {
    ...
    i || te.log("URLParser::_parse -> Invalid URL");
...
function We(e) {
  ...
  if (typeof window.URL == "function" && function() {
    ...
    (r = new URL(e)).searchParams || (r.searchParams = (t = sr(r.search), {
      get(i) {
        return t[i];
      }
    }));
    ...
    if (g(e) || (e = String(e)), e = Fe(e), /^https?:\/\/.+/.test(e) === !1)
      return void te.log("Invalid URL");
    let i = Vr(e);
    r.hash = i._values.Fragment, r.host = i._values.Host ? i._values.Host + (i._values.Port ? `:${i._values.Port}` : "") : "", r.href = i._values.URL, r.password = i._values.Password, r.pathname = i._values.Path, r.port = i._values.Port, r.search = i._values.QueryString ? `?${i._values.QueryString}` : "", r.username = i._values.Username, r.hostname = i._values.Hostname, r.protocol = i._values.Protocol ? `${i._values.Protocol}:` : "", r.origin = i._values.Origin ? i._values.Origin + (i._values.Port ? `:${i._values.Port}` : "") : "", r.searchParams = function() {
      let n = sr(`?${i._values.QueryString}`);
      return {
        get(a) {
          return n[a];
        }
...
ar.prototype.get = function(e, t, r, i) {
  if (!e)
    throw new Error("key is must");
  t = t || 1e4, r = r || 1e3, i = i || function() {
  };
  let n = this.lockGetPrefix + e, a = I.get(n), l = String(be());
  if (a && (a = ne(a) || { randomNum: 0, expireTime: 0 }).expireTime > ye())
    return i(null);
  I.set(
    n,
    JSON.stringify({ randomNum: l, expireTime: ye() + t })
  ), setTimeout(() => {
    (a = ne(I.get(n)) || {
      randomNum: 0,
      expireTime: 0
...
}, ar.prototype.set = function(e, t, r, i, n) {
  if (!e || !t)
    throw new Error("key and val is must");
  r = r || 1e4, i = i || 1e3, n = n || function() {
  };
  let a = this.lockSetPrefix + e, l = I.get(a), u = String(be());
  if (l && (l = ne(l) || { randomNum: 0, expireTime: 0 }).expireTime > ye())
    return n({ status: "fail", reason: "This key is locked" });
  I.set(
    a,
    JSON.stringify({ randomNum: u, expireTime: ye() + r })
  ), setTimeout(() => {
    (l = ne(I.get(a)) || {
      randomNum: 0,
      expireTime: 0
...
let it = /* @__PURE__ */ function() {
  ...
  return function() {
    ...
    return t = t && /\d{5,}/.test(t) ? t.toString(16) : String(31242 * be()).replace(".", "").slice(0, 8), `${e()}-${be().toString(16).replace(".", "")}-${function() {
    ...
    }()}-${t}-${e()}` || (String(be()) + String(be()) + String(be())).slice(
      2,
      15
    );
  };
...
function gt(e, t, r, i) {
  ...
  n._getPath = function() {
    return this.path || this.composedPath && this.composedPath() || ve(this.target).getParents();
    ...
    if (i === void 0 && l === "click" && (i = !0), a && a.addEventListener)
      ...
      let p = `on${l}`, b = a[p];
      a[p] = /* @__PURE__ */ function(w, L, P, Se) {
        return function(J) {
          if (!(J = J || n(window.event)))
            return;
          J.target = J.srcElement;
          let Te, at, ge = !0;
          return typeof P == "function" && (Te = P(J)), at = L.call(w, J), Se !== "beforeunload" ? (Te !== !1 && at !== !1 || (ge = !1), ge) : void 0;
        };
      }(a, u, b, l);
    }
...
function Ct(e) {
  let t = [];
  try {
    t = on(atob(e).split(""), (r) => `%${`00${r.charCodeAt(0).toString(16)}`.slice(-2)}`);
  } catch {
    t = [];
  }
  try {
...
rn.prototype = {
  ...
  attr(e, t) {
    return typeof e == "string" && Re(t) ? this.ele.getAttribute(e) : (typeof e == "string" && (t = String(t), this.ele.setAttribute(e, t)), this);
  },
  offset() {
  ...
  wrap(e) {
    ...
    return this.ele.parentNode.insertBefore(t, this.ele), t.appendChild(this.ele), ve(t);
  },
  getCssStyle(e) {
  ...
  parent() {
    ...
    return ve(e = e && e.nodeType !== 11 ? e : null);
  },
  previousElementSibling() {
    let e = this.ele;
    if ("previousElementSibling" in document.documentElement)
      return ve(e.previousElementSibling);
...
let ot = {
  get(e) {
    for (let r = `${e}=`, i = document.cookie.split(";"), n = 0; n < i.length; n++) {
      ...
      if (t.indexOf(r) == 0)
        return Ve(t.substring(r.length, t.length));
    }
    return null;
  },
  set(e, t, r, i, n, a) {
    ...
    let L = "", P = "", Se = "";
    e && (L = w(e)), t && (P = w(t)), l && (Se = w(l)), L && P && (document.cookie = `${L}=${encodeURIComponent(P)}${u}; path=/${Se}${b}${p}`);
  },
  remove(e, t) {
    this.set(e, "1", -1, t);
  },
      ...
      a = function(u, p) {
        ...
        if (u.indexOf("#") === 0)
          ...
          if (!P || !P[1])
            return null;
          let Se = Number(P[1]);
          if (!(ae(p) && p.children && p.children.length > 0))
            return null;
          for (let J = p.children, Te = 0; Te < J.length; Te++)
            if (ae(J[Te]) && J[Te].tagName.toLowerCase() === L && --Se == 0) {
              b = J[Te];
              break;
            }
          if (Se > 0)
...
function mn(e) {
  return typeof e != "string" ? !1 : /^https?:\/\/.+/.test(e) !== !1 || (te.log("Invalid URL"), !1);
}
function yn() {
...
function Da() {
  ...
  if (typeof navigator != "object" || typeof navigator.sendBeacon != "function")
    return e;
  let t = Xr(), r = navigator.userAgent.toLowerCase();
  ...
  ({
    ...
    listen() {
      if (this.isSupport()) {
        ...
        gt(window, "focus", this.visibleHandler), gt(window, "blur", this.hiddenHandler);
    }
  }).init();
}
function fr(e) {
...
function Ia(e, t, r) {
  ...
  r || (r = {});
  let p = function() {
    u = r.leading === !1 ? 0 : ye(), l = null, a = e.apply(i, n), l || (i = n = null);
  };
  return function() {
    let b = ye();
    u || r.leading !== !1 || (u = b);
...
function ja(e) {
  return e ? e.toArray ? e.toArray() : j(e) || fn(e) ? Array.prototype.slice.call(e) : $n(e) : [];
}
function Qt(e) {
...
function B() {
  yt.msg.apply(yt, arguments).level("error").log();
}
let h = {}, er = {
  preset_properties: {
...
let kn = "utm_source utm_medium utm_campaign utm_content utm_term", hr = "1.27.11", Cn = "sensorsdata_domain_test", Rt = {
...
let Ne = {
  ...
  set(e, t, r, i) {
    let n = "";
    if (i = Re(i) ? h.cross_subdomain : i) {
      let a = Qr(location.href);
  ...
  remove(e, t) {
    return t = Re(t) ? h.cross_subdomain : t, ot.remove(e, t);
  },
  isSupport(e, t) {
    return e = e || "sajssdk_2015_cookie_access_test", t = t || "1", ot.isSupport(e, t, 0, null, h.is_secure_cookie);
  }
};
function Fn(e, t) {
  let r = "";
  if (h.cross_subdomain === !1) {
    try {
      if (!t) {
        let i = location.host;
        Re(s.para.white_list[i]) || (r = s.para.white_list[i]);
      }
    } catch (i) {
      B(i);
    }
...
function lr() {
  return Ne.isSupport() ? Ne.get("sensorsdata_is_new_user") !== null || Ne.get(Fn("new_user")) !== null : ur.get(ur.getNewUserFlagMemoryKey("new_user")) !== null;
}
Ne.getNewUser = lr;
var ur = {
  data: {},
...
let Ht = {
  checkIsAddSign(e) {
    e.type === "track" && (lr() ? e.properties.$is_first_day = !0 : e.properties.$is_first_day = !1);
  },
  ...
  storeInitCheck() {
    if (s.is_first_visitor) {
      ...
      Ne.isSupport() ? Ne.set(
        ...
        ur.getNewUserFlagMemoryKey("new_user"),
        "1",
        `${3600 * t.h + 60 * t.m + t.s}s`
      ), this.is_first_visit_time = !0, this.is_page_first_visited = !0;
    } else
      lr() || (this.checkIsAddSign = function(e) {
...
function lt(e, t, r) {
  ...
  return d(h.heatmap) && Re(h.heatmap.useCapture) && t === "click" && (i = !0), gt(e, t, r, i);
}
let ei = function() {
...
let Mt = {
  data: {},
  id() {
    return this.data.id ? this.data.id : (this.data.id = Dn(), this.data.id);
  },
  type() {
    return this.data.type ? this.data.type : (this.data.type = En(), this.data.type);
  }
};
function En() {
  let e = Ut(document.referrer);
  if (oe(e) || !e.eqid) {
    let t = Ut(location.href);
...
function Dn() {
  let e = Ut(document.referrer);
  return oe(e) || !e.eqid ? it().replace(/-/g, "") : e.eqid;
}
function Ge(e, t) {
...
function jt(e, t) {
  ...
  if (document && g(e)) {
    if (e.indexOf("http") === 0) {
      let i = Pn(e), n = Ut(e);
      if (oe(n))
        return h.preset_properties.search_keyword_baidu && Jt() ? void 0 : "未取到值";
      let a = null;
      for (let l in r)
        if (i === l && d(n)) {
          if (j(a = r[l]))
...
let tt = {
  ...
  apph5(e) {
    ...
    i !== "all" && i !== "console" || Me(r[n]), (i === "all" || i === "code") && d(h.is_debug) && h.is_debug.apph5 && (a.type && a.type.slice(0, 7) === "profile" || (a.properties._jssdk_debug_info = `apph5-${String(n)}`));
  },
  defineMode(e) {
    let t = {
      1: {
...
var T = {
  initPage() {
    let e = Ge(), t = le(), r = Qr(t);
    r || tt.jssdkDebug(`url_domain异常_${t}_${r}`), this.pageProp = {
      referrer: e,
      referrer_host: e ? He(e) : "",
      url: t,
      url_host: He(t, "url_host取值异常"),
      url_domain: r
    };
  },
  pageProp: {},
...
function Nn(e) {
  ...
  return i.$element_type = r, i.$element_name = t.getAttribute("name"), i.$element_id = t.getAttribute("id"), i.$element_class_name = g(t.className) ? t.className : null, i.$element_target_url = t.getAttribute("href"), i.$element_content = dr(t, r), (i = jn(i)).$url = le(), i.$url_path = _t(), i.$title = document.title, i;
}
function Ra(e) {
...
function dr(e, t) {
  return g(t) && t.toLowerCase() === "input" ? Ra(e) : pn(e, t);
}
function ri(e) {
  return tt.protocol.ajax(e.url), sn(e);
}
function On(e, t) {
...
let hi = "sawebjssdk-", br = "tab-sawebjssdk-";
function xn() {
...
xn.prototype = {
  ...
  send() {
    ...
    if (e) {
      this.sendTimeStamp = ye();
      let i = Qt(
        (e = ne(e) || this.generateTabStorageVal()).data
      );
      if (i.length) {
  ...
  updateExpireTime() {
    let e = I.get(this.tabKey);
    e && ((e = ne(e) || this.generateTabStorageVal()).expireTime = ye() + 2 * h.batch_send.send_interval, e.serverUrl = this.serverUrl, I.set(this.tabKey, JSON.stringify(e)));
  },
  request(e, t) {
  ...
  remove(e) {
    ...
    if (t) {
      for (var r = (ne(t) || this.generateTabStorageVal()).data, i = 0; i < e.length; i++) {
        let n = se(r, e[i]);
  ...
  add(e) {
    let t = hi + String(be()), r = I.get(this.tabKey);
    r === null ? (this.tabKey = br + String(be()), r = this.generateTabStorageVal()) : r = ne(r) || this.generateTabStorageVal(), r.data.push(t), r.expireTime = ye() + 2 * h.batch_send.send_interval, I.set(this.tabKey, JSON.stringify(r)), s.store.saveObjectVal(t, e), e.type !== "track_signup" && e.event !== "$pageview" || this.sendImmediately();
  },
  generateTabStorage() {
    this.tabKey = br + String(be()), I.set(
      this.tabKey,
  ...
  generateTabStorageVal(e) {
    return {
      data: e = e || [],
      expireTime: ye() + 2 * h.batch_send.send_interval,
  ...
  recycle() {
    for (var e = {}, t = 0; t < localStorage.length; t++) {
      ...
      var r = this;
      if (a.indexOf(br) === 0) {
        for (var i = ne(I.get(a)) || this.generateTabStorageVal(), n = 0; n < i.data.length; n++)
          e[i.data[n]] = !0;
        a !== r.tabKey && ye() > i.expireTime && this.serverUrl === i.serverUrl && new ar("sajssdk-lock-get-").get(
          a,
          1e4,
          1e3,
          (l) => {
            if (l) {
              ...
              let u = ne(l) || r.generateTabStorageVal(), p = ne(I.get(r.tabKey)) || r.generateTabStorageVal();
              p.data = Qt(p.data.concat(u.data)), I.set(r.tabKey, JSON.stringify(p));
            }
          }
        );
      } else if (a.indexOf("sajssdk-lock-get-") === 0) {
        let l = ne(I.get(a)) || { expireTime: 0 };
        ye() - l.expireTime > 1e4 && I.remove(a);
      }
    }
    for (let a = 0; a < localStorage.length; a++) {
      let l = localStorage.key(a);
      l.indexOf(hi) !== 0 || e[l] || I.remove(l);
    }
  }
};
let Ur = function(e) {
...
}, tr.prototype.lastClear = function() {
...
var c = {
  ...
  getUnionId(e) {
    ...
    return t.login_id && this._state.history_login_id && this._state.history_login_id.name && this._state.history_login_id.name !== Rt.LOGIN && (t.login_id = `${this._state.history_login_id.name}+${t.login_id}`), t;
  },
  getFirstId() {
  ...
  set(e, t) {
    ...
    this._state[e] = t, e === "first_id" ? delete this._state._first_id : e === "distinct_id" && delete this._state._distinct_id, this.save(), e === "distinct_id" && r && Un.tempAdd("changeDistinctId", t);
  },
  change(e, t) {
    this._state[`_${e}`] = t;
  },
...
/`) === 0 ? i.identities = ne(Sn(i.identities)) : i.identities = ne(
          Ct(i.identities)
        ));
        let a = c.getOriginUnionId(i);
        i.identities && d(i.identities) && !oe(i.identities) || (i.identities = {}, i.identities.$identity_cookie_id = it()), i.history_login_id = i.history_login_id || {};
    ...
    }(r)), Ht.setDeviceId(r, this), Ht.storeInitCheck();
  },
  saveObjectVal(e, t) {
  ...
  readObjectVal(e) {
    let t = I.get(e);
    return t ? ne(t = s.kit.userDecryptIfNeeded(t)) : null;
  }
};
let V = {
  string(e) {
  ...
  unbindReservedNames: ["$identity_anonymous_id", Rt.LOGIN],
  string(e) {
    return !!g(e);
  },
  emptyString(e) {
  ...
  reservedLoginId(e) {
    return !(se(this.loginIDReservedNames, e) > -1);
  },
  reservedUnbind(e) {
    return !(se(this.unbindReservedNames, e) > -1);
  },
  reservedBind(e) {
...
function Ka(e, t) {
  return d(e) && D(e, (r, i) => {
    ...
    if (d(r) && i !== "$option" && !n)
      ...
      g(r) || Je(r) || Vt(r) || hn(r) || j(r) || $(r) || i === "$option" || n || (k(
        "您的数据-",
        i,
        r,
        "-格式不满足要求，我们已经将其删除"
...
function Rn(e) {
  ...
  d(e) && D(e, (i, n) => {
    if (d(i))
      ...
      e[n] = qa(
        i,
        se(t, n) > -1 ? 1024 : h.max_string_length
      );
    }
  });
}
...
function Ya(e) {
  let t = e.properties;
  Gr(e), d(t) ? (Ka(t), Va(t), Wa(e), Xa(t), Rn(t)) : "properties" in e && (e.properties = {}), za(e);
}
function Za(e, t) {
  let r = t.sensors;
...
var G = {
  initUrl() {
    ...
    if (!mn(s.para.server_url))
      return B(
        "----vcollect---server_url必须为有效 URL 字符串"
      ), !1;
    try {
      e = We(s.para.server_url), r.server_url.project = e.searchParams.get("project") || "default", r.server_url.host = e.host;
    } catch (i) {
      return B("----vcollect---server_url解析异常", i), !1;
    }
    try {
      t = We(location.href), r.page_url.host = t.hostname, r.page_url.pathname = t.pathname;
    } catch (i) {
      return B(
        "----vcollect---页面地址解析异常",
        i
  ...
  configIsMatch(e, t) {
    return (!t.limit_element_content || t.element_content === e.$element_content) && (!t.limit_element_position || t.element_position === String(e.$element_position)) && (t.element_field && t.function ? G.configIsMatchNew(e, t) : G.configIsMatchOldVersion(e, t));
  },
  configIsMatchOldVersion(e, t) {
    ...
    if (e.$element_position !== void 0) {
      if (t.element_path !== e.$element_path)
        return !1;
    } else if (G.isDiv({ element_path: t.element_path })) {
  ...
  filterConfig(e, t, r) {
    ...
    return e.event === "$WebClick" && D(t, (n) => {
      d(n) && (n.event_type === "webclick" || n.event_type === "appclick") && d(n.event) && n.event.url_host === r.host && n.event.url_path === r.pathname && G.configIsMatch(e.properties, n.event) && i.push(n);
    }), i;
  },
  getPropElInLi(e, t) {
  ...
  getProp(e, t) {
    ...
    if (e.method === "content") {
      ...
      if (a.tagName.toLowerCase() === "input")
        ...
        Je(l) && ae(a[l]) && (r = dr(a[l], "select"));
      } else
        r = dr(a, a.tagName.toLowerCase());
      if (e.regular) {
        try {
...
let Ga = {
  ...
  filterWebClickEvents(e) {
    this.events = nt.getAssignConfigs((t) => !(!d(t) || t.event.unlimited_div !== !0 || t.event_type !== "webclick"), e);
  },
  isTargetEle(e) {
    ...
    for (let r = 0; r < this.events.length; r++)
      if (d(this.events[r]) && d(this.events[r].event) && nt.configIsMatch(t, this.events[r].event))
        return !0;
    return !1;
  }
}, Hn = {
...
var nt = {
  ...
  initUrl() {
    ...
    if (e) {
      let t;
      try {
        (t = new Vr(s.para.server_url))._values.Path = "/config/visualized/Web.conf", e.api_url = t.getUrl();
      } catch (r) {
        return B(
    ...
    if (this.storageEnable) {
      ...
      if (d(e) && d(e.data))
        if (this.serverUrlIsSame(e.serverUrl)) {
          ...
          if (Je(t) && t > 0 && t < this.para.session_time) {
  ...
  pageStateListenner() {
    ...
    bn({
      visible() {
        ...
        if (Je(t) && t > 0 && t < e.para.update_interval) {
  ...
  sendRequest(e, t) {
    ...
    this.config.version && (r.v = this.config.version), vn({
...
function Qa(e, t) {
  try {
    ...
    return d(e) && d(e.properties) && !oe(e.properties) && (e.properties.$lib_detail && (n.lib.$lib_detail = e.properties.$lib_detail, delete e.properties.$lib_detail), e.properties.$lib_method && (n.lib.$lib_method = e.properties.$lib_method, delete e.properties.$lib_method)), cn(n, c.getUnionId(), e), d(e.properties) && !oe(e.properties) && A(n.properties, e.properties), n.event === "$UnbindID" && (n.login_id && delete n.login_id, n.anonymous_id && delete n.anonymous_id), e.type && e.type.slice(0, 7) === "profile" || (r.para.properties_priority && r.para.properties_priority === 3 ? n.properties = A(
      {},
      T.properties(),
      c.getSessionProps(),
      T.currentProps,
...
function yi(e, t, r, i) {
  ...
  e.event && a(e.event), e.ele && lt(e.ele, "click", (l) => {
    a(l);
  });
}
function Jn() {
...
var Be = {
  ...
  isUnlimitedTag(e) {
    ...
    return wr[t] || Yr(e, s.para.heatmap.track_attr);
  },
  getTargetElement(e, t) {
    ...
    if (n === "a" || n === "button" || n === "input" || n === "textarea" || se(l, n) > -1)
      return i;
    if (n === "area" && a.tagName.toLowerCase() === "map" && ve(a).prev().tagName && ve(a).prev().tagName.toLowerCase() === "img")
      return ve(a).prev();
  ...
  getDivLevels(e, t) {
    let r = Be.getElementPath(e, !0, t).split(" > "), i = 0;
    return D(r, (n) => {
      n === "div" && i++;
    }), i;
  },
  isDivLevelValid(e) {
    for (let t = s.para.heatmap && s.para.heatmap.collect_tags && s.para.heatmap.collect_tags.div && s.para.heatmap.collect_tags.div.max_level || 1, r = e.getElementsByTagName("div"), i = r.length - 1; i >= 0; i--)
      if (Be.getDivLevels(r[i], e) > t)
        return !1;
    return !0;
  },
  getElementPath(e, t, r) {
    for (var i = []; e.parentNode && ae(e); ) {
      if (!g(e.tagName))
        return "unknown";
  ...
  getElementPosition(e, t, r) {
    ...
    return function(p) {
      if (!p.parentNode)
        return "";
      if (ve(p).getSameTypeSiblings().length === 1)
        return 0;
      for (var b = 0, w = p; ve(w).previousElementSibling().ele; w = ve(w).previousElementSibling().ele, b++) ;
      return b;
    }(i);
  },
  setNotice(e) {
    s.is_heatmap_render_mode = !0, s.para.heatmap || (s.errorMsg = "您 SDK 没有配置开启点击图 ！"), e && e.slice(0, 5) === "http:" && location.protocol === "https:" && (s.errorMsg = "您的当前页面是 https 的地址，神策分析环境也必须是 https ！"), s.para.heatmap_url || (s.para.heatmap_url = `${Jn()}//static.sensorsdata.cn/sdk/${s.lib_version}/heatmap.min.js`);
  },
  getDomIndex(e) {
    if (!e.parentNode)
      return -1;
  ...
  getEleDetail(e) {
    ...
    return Je(i) && (r.$element_position = i), r;
  },
  ...
  initHeatmap() {
    ...
    $(s.para.heatmap.collect_url) && this.listenUrlChange(() => {
      ...
      if (!ae(a) && !g(n.tagName))
        return !1;
      ae(a) && g(a.tagName) ? e.start(i, a, a.tagName.toLowerCase()) : ae(n) && n.tagName.toLowerCase() === "div" && d(s.para.heatmap) && s.para.heatmap.get_vtrack_config && pr.events.length > 0 && pr.isTargetEle(n) && e.start(i, n, n.tagName.toLowerCase(), {
        $lib_method: "vtrack"
      });
    });
  }
...
function vi(e, t, r) {
  if (s.is_first_visitor && r) {
    let i = {};
    s.para.preset_properties.search_keyword_baidu && cr(document.referrer) && Jt() && (i.$search_keyword_id = Mt.id(), i.$search_keyword_id_type = Mt.type(), i.$search_keyword_id_hash = Zr(i.$search_keyword_id));
    let n = document.characterSet || document.charset, a = Ge(null, t);
    e(
      A(
        {
          $first_visit_time: /* @__PURE__ */ new Date(),
          $first_referrer: a,
          $first_referrer_host: a ? He(a, "取值异常") : "",
...
let rr = {
  ...
  trackHeatMap(e, t, r) {
    if (typeof e == "object" && e.tagName && ae(e.parentNode)) {
      ...
      i === "button" || i === "a" || n === "a" || n === "button" || i === "input" || i === "textarea" || Yr(e, a) || Be.start(null, e, i, t, r);
    }
  },
  trackAllHeatMap(e, t, r) {
    if (typeof e == "object" && e.tagName) {
      let i = e.tagName.toLowerCase();
      Be.start(null, e, i, t, r);
    }
  },
  autoTrackSinglePage(e, t) {
    ...
    e.not_set_profile && delete e.not_set_profile, n(e, t), this.autoTrackSinglePage = n, vi(s.setOnceProfile, !1, i);
  },
  ...
  autoTrack(e, t) {
    e = d(e) ? e : {};
    let r = Rr(), i = !e.not_set_profile;
    e.not_set_profile && delete e.not_set_profile;
    let n = location.href;
    s.para.is_single_page && nn(() => {
      let a = Ge(n, !0);
      s.track(
        "$pageview",
        A(
      ...
      t
    ), vi(s.setOnceProfile, !0, i), this.autoTrackIsUsed = !0;
  },
  getAnonymousID() {
    return oe(c._state) ? "SDK is not initialized." : c.getAnonymousId();
  },
  setPlugin(e) {
    if (!d(e))
      return !1;
...
function os(e) {
  ...
  for (t in s.para.preset_properties = A(
    {},
    er.preset_properties,
    r,
    s.para.preset_properties || {}
  ), er)
    s.para[t] === void 0 && (s.para[t] = er[t]);
  typeof s.para.web_url != "string" || s.para.web_url.slice(0, 3) !== "://" && s.para.web_url.slice(0, 2) !== "//" || (s.para.web_url.slice(0, 3) === "://" ? s.para.web_url = location.protocol.slice(0, -1) + s.para.web_url : s.para.web_url = location.protocol + s.para.web_url), tt.protocol.serverUrl(), s.bridge && s.bridge.initPara();
  let i = [
    "utm_source",
    "utm_medium",
    "utm_campaign",
  ...
  if (s.para.heatmap && !d(s.para.heatmap) && (s.para.heatmap = {}), d(s.para.heatmap)) {
    ...
    let p = j(s.para.heatmap.track_attr) ? dn(s.para.heatmap.track_attr, (b) => b && typeof b == "string") : [];
...
function $s(e, t) {
  ...
  }), ue.send({ type: "profile_unset", properties: i }, t)) : B(
...
function Wn(e, t) {
  typeof e == "number" && (e = String(e)), !Mn({ id: e, callback: t, name: Rt.LOGIN }, si) && $(t) && t();
}
function js(e, t) {
  return k("loginWithKey is deprecated !!!"), typeof t == "number" && (t = String(t)), typeof e == "number" && (e = String(e)), !!K({ loginIdKey: e }) && (Rt.LOGIN === e ? (Wn(t), !1) : void Mn({ id: t, callback: null, name: e }, si));
}
function Ns(e) {
  let t = c.getFirstId();
  if (t)
...
function Os() {
  let e, t, r = {
    ...
    $referrer_host: T.pageProp.referrer ? He(T.pageProp.referrer) : "",
    $url: le(),
    $url_path: _t(),
    $title: document.title || "",
...
function Ls() {
  ...
  s.heatmap && j(s.heatmap.otherTags) && D(s.heatmap.otherTags, (r) => {
    e += r + t;
  }), yn() && jr() && jr() < 13 && (s.para.heatmap && s.para.heatmap.collect_tags && s.para.heatmap.collect_tags.div && Gt(`div, [data-sensors-click]${t}`), s.para.heatmap && s.para.heatmap.track_attr && Gt(`[${s.para.heatmap.track_attr.join("], [")}]${t}`), e !== "" && Gt(e));
}
let xs = {
  bridge_info: {
    touch_app_bridge: !1,
  ...
  app_js_bridge_v1() {
    ...
    window.sensorsdata_app_js_bridge_call_js = function(r) {
      (function(i) {
        or(e = i) && (e = JSON.parse(e)), t && (t(e), t = null, e = null);
      })(r);
      ...
      }(), typeof window.SensorsData_APP_JS_Bridge == "object" && window.SensorsData_APP_JS_Bridge.sensorsdata_call_app && or(
...
function Us(e) {
  function t(n) {
    ...
    try {
      n = We(n), a.hostname = n.hostname, a.project = n.searchParams.get("project") || "default";
    } catch (l) {
      B(`validateAppUrl:${l}`);
    }
    return a;
...
function Rs() {
  ...
  if (h.preset_properties.search_keyword_baidu ? cr(document.referrer) && (!Jt() || d(r) && r.active ? c._state && c._state.props && (c._state.props.$search_keyword_id && delete c._state.props.$search_keyword_id, c._state.props.$search_keyword_id_type && delete c._state.props.$search_keyword_id_type, c._state.props.$search_keyword_id_hash && delete c._state.props.$search_keyword_id_hash) : (t.$search_keyword_id = Mt.id(), t.$search_keyword_id_type = Mt.type(), t.$search_keyword_id_hash = Zr(t.$search_keyword_id))) : c._state && c._state.props && (c._state.props.$search_keyword_id && delete c._state.props.$search_keyword_id, c._state.props.$search_keyword_id_type && delete c._state.props.$search_keyword_id_type, c._state.props.$search_keyword_id_hash && delete c._state.props.$search_keyword_id_hash), c.save(), D(h.preset_properties, (i, n) => {
    ...
    if (n = n.slice(7), i) {
      ...
      else if (cr(document.referrer))
        switch (n) {
          case "traffic_source_type":
            t.$latest_traffic_source_type = ti();
            break;
          case "referrer":
...
var Ze = {
  ...
  isWindowNameHasKeyword() {
    try {
      let e = JSON.parse(window.name), t = g(e["sa-heatmap-src"]) ? Ve(e["sa-heatmap-src"]) : null;
  ...
  loadVtrack() {
    fr({
      ...
      type: "js",
      url: s.para.vtrack_url ? s.para.vtrack_url : `${Jn()}//static.sensorsdata.cn/sdk/${s.lib_version}/vtrack.min.js`
    });
  },
  messageListener(e) {
    ...
    if (e.data.type === "v-track-mode") {
      if (e.data.data && e.data.data.isVtrack)
        if ($t.isSupport() && sessionStorage.setItem("sensors-visual-mode", "true"), e.data.data.userURL && location.href.match(/sa-visual-mode=true/)) {
          ...
          Ie.loadVtrack();
      window.removeEventListener("message", Ie.messageListener, !1);
    }
  },
  removeMessageHandle() {
    window.removeEventListener && window.removeEventListener("message", Ie.messageListener, !1);
  },
  verifyVtrackMode() {
    window.addEventListener && window.addEventListener("message", Ie.messageListener, !1), Ie.postMessage();
  },
  postMessage() {
    try {
  ...
  notifyUser() {
    ...
    window.addEventListener && window.addEventListener("message", e, !1), Ie.postMessage();
  }
};
function Sr(e) {
  ...
  function r() {
    let i = [];
    t.touch_app_bridge || i.push(tt.defineMode("1")), d(s.para.app_js_bridge) || (i.push(tt.defineMode("2")), t.verify_success = !1), d(s.para.heatmap) && s.para.heatmap.clickmap == "default" || i.push(tt.defineMode("3")), t.verify_success === "fail" && i.push(tt.defineMode("4")), new s.SDKJSBridge("app_alert").notifyApp({ data: i });
  }
      ...
      if (d(s.para.app_js_bridge) && t.verify_success === "success")
        if (e)
          ...
          fr({
            ...
            type: "js",
            url: `${i = se(["http:", "https:"], i) > -1 ? i : "https:"}//static.sensorsdata.cn/sdk/${s.lib_version}/vapph5define.min.js`
          });
        }
      else
        r();
...
}, Yn = new ft(Ys), Zs = { send: null }, Zn = new ft(Zs), Gs = { getUtmData: null, callSchema: null }, Gn = new ft(Gs), Qs = { webClickEvent: null, webStayEvent: null }, Qn = new ft(Qs);
function $r(e) {
  e && e.buildDataStage && Yn.registerStageImplementation(e.buildDataStage), e && e.businessStage && Gn.registerStageImplementation(e.businessStage), e && e.sendDataStage && Zn.registerStageImplementation(e.sendDataStage), e && e.viewStage && Qn.registerStageImplementation(e.viewStage);
}
let $i = {
  buildDataStage(e) {
...
function to(e) {
  return ea.stage.process("send", e);
}
let At = {};
function ro(e) {
  e.kit = At, e.saEvent = ue, this.buildDataStage = ni, this.sendDataStage = ea, this.businessStage = Jr;
}
function io(e) {
...
let ki = window.sensors_data_pre_config, Ci = !!zn.isObject(ki) && ki.is_compliance_enabled;
function kr(e) {
  e && (s.events = Un, s.bridge = xs, s.SDKJSBridge = Nt, s.JSBridge = Xn, s.store = c, s.unlimitedDiv = pr, s.customProp = Hn, s.vtrackcollect = nt, s.vapph5collect = ii, s.detectMode = Ks, s.registerFeature = $r, s.registerInterceptor = Hr, s.commonWays = rr, $r(new ro(s)), $r(new io(s)), Hr("viewStage", no));
  let t = e ? Ts : Ws;
  for (let r in t) s[r] = t[r];
  s.logger = yt, s.log = Me, s._ = zn, s.on = Ln, s.ee = z, s.use = qn, s.lib_version = hr, s.registerPropertyPlugin = ao;
}
s.init = function(e) {
...
function ko() {
  je = window.SensorsData_APP_New_H5_Bridge, gr = je && je.sensorsdata_track, Dt = gr && je.sensorsdata_get_server_url && je.sensorsdata_get_server_url(), ht("---test---fail---", !M, M.bridge.activeBridge, !Dt), M && !M.bridge.activeBridge && Dt && (M.bridge.activeBridge = ta, M.para.app_js_bridge && !M.para.app_js_bridge.is_mui && (M.bridge.is_verify_success = Dt && M.bridge.validateAppUrl(Dt), ht("---test---bridge-verify-", M.bridge.is_verify_success)), M.bridge.bridge_info = {
    touch_app_bridge: !0,
    platform: "android",
...
function No() {
  if (Ae("ObsoleteBridge---test---init---"), me = window.SensorsData_APP_JS_Bridge, bt = me && me.sensorsdata_track, ut = me && me.sensorsdata_verify, Pt = me && me.sensorsdata_visual_verify, Ae(
    ...
    bt,
    Pt
  ), Q && !Q.bridge.activeBridge && (ut || bt || Pt)) {
    Q.bridge.activeBridge = ra;
    let e = ut || bt;
    Pt && (e = !!Pt.call(
      me,
      JSON.stringify({ server_url: Q.para.server_url })
    ), Ae("ObsoleteBridge---called-return", e)), Q.bridge.bridge_info = {
      touch_app_bridge: !0,
      platform: "android",
...
function Oo(e, t) {
  ...
  if (ut) {
    let i = ut && ut.call(
      me,
      JSON.stringify(
        st.extend({ server_url: Q.para.server_url }, e.data)
      )
    );
    return Ae("ObsoleteBridge---anVerify-success", i), i ? (st.isFunction(r) && r(), t.cancellationToken.cancel(), e) : Q.para.app_js_bridge.is_send ? (Q.debug.apph5({ data: e.data, step: "3.1", output: "all" }), e) : (st.isFunction(r) && r(), t.cancellationToken.cancel(), e);
  }
  return Ae("ObsoleteBridge---is-send-old-way", Q.para.app_js_bridge.is_send), bt && bt.call(
    me,
    JSON.stringify(
      st.extend({ server_url: Q.para.server_url }, e.data)
    )
...
var Ce = {
  ...
  addLatestChannelUrl() {
    ...
    else if (he.isReferralTraffic(document.referrer)) {
  ...
  eventList: {
    init() {
      ...
      if (e && he.isNumber(e.latest_event_initial_time) && he.isArray(e.eventList)) {
        let r = t - e.latest_event_initial_time;
        r > 0 && r < Ce.max_save_time ? (Ce.event_list = e.eventList, Ce.latest_event_initial_time = e.latest_event_initial_time) : this.reset();
      } else
        this.reset();
    },
    get() {
    ...
    add(e) {
      Ce.event_list.push(e), this.save();
    },
    save() {
      let e = {
        latest_event_initial_time: Ce.latest_event_initial_time,
        eventList: Ce.event_list
      };
      Fr.saveObjectVal("sawebjssdkchannel", e);
    },
    reset() {
      Ce.event_list = [], Ce.latest_event_initial_time = (/* @__PURE__ */ new Date()).getTime(), this.save();
    },
    hasEvent(e) {
      let t = !1;
      return he.each(Ce.event_list, (r) => {
        r === e && (t = !0);
      }), t;
    }
  }
...
var Bt = {
  ...
  init(e) {
    ...
    if (Yt(t) && this.sd._.isNumber(t.timeout) && t.timeout >= 2500 && (this.timeout = t.timeout), !this.sd.para.server_url)
      return this.logger(
    ...
    this.key = n[2], this.apiURL = this.apiURL.replace(
      ...
      success: (function(a) {
        if (a.errorMsg)
          return Bt.logger(`API报错：${a.errorMsg}`), !1;
        Bt.data = a, Bt.logger(
  ...
  openDeepLink() {
    ...
    if (ir === "iOS") {
      ...
      this.logger("当前系统是 HarmonyOS"), Oi(this, e, this.data.harmony_info.download_url);
    }
  },
  logger(e) {
    this.sd && this.sd.log(e);
  ...
  addListeners() {
    let e = ia().visibilityChange, t = this;
...
function rl() {
  ...
  }, W && !W.bridge.activeBridge && mt() && mt().postMessage && (W.bridge.activeBridge = aa, W.para.app_js_bridge && !W.para.app_js_bridge.is_mui && (W.bridge.is_verify_success = Dr && W.bridge.validateAppUrl(Dr)), W.bridge.bridge_info = {
    touch_app_bridge: !0,
    platform: "ios",
...
function il(e, t) {
  if (W.para.app_js_bridge.is_mui || e.data.type === "item_set" || e.data.type === "item_delete")
    return e;
  let r = e.callback;
  return W.bridge.is_verify_success ? (mt() && mt().postMessage(
    JSON.stringify({
      callType: "app_h5_track",
      data: Tt.extend({ server_url: W.para.server_url }, e.data)
    })
...
let ee, kt, qr, Ti = tl(aa, "IOSBridge", "sdkAfterInitPara"), al = "1.27.11";
function sl(e, t, r) {
  if (e.plugin_name = t, e.init) {
    let i = e.init;
    e.init = function(n, a) {
...
function ul() {
  ee && !ee.bridge.activeBridge && cl() && (ee.bridge.activeBridge = sa, ee.bridge.bridge_info = {
    touch_app_bridge: !0,
    platform: "ios",
...
Y.prototype.init = function(e, t) {
  if (e) {
    ...
    this.log("神策JS SDK未成功引入");
}, Y.prototype.log = function(e) {
  this.sd && this.sd.log(e);
}, Y.prototype.refreshPageEndTimer = function() {
  let e = this;
  this.timer && (clearTimeout(this.timer), this.timer = null), this.timer = setTimeout(() => {
    e.page_hidden_status = !1;
  }, ml);
  ...
  let e = this.getPageLeaveProperties();
  this.start_time = +/* @__PURE__ */ new Date(), document.hidden ? this.page_show_status = !1 : this.page_show_status = !0, this.url = location.href, this.isCollectUrl(this.url) && this.sd.track(this.option.event_name_view, Object.assign(e, this.option.urlPropertyMap(this.url))), this.title = document.title;
}, Y.prototype.pageEndHandler = function() {
  if (this.page_hidden_status !== !0) {
    let e = this.getPageLeaveProperties();
    this.page_show_status === !1 && delete e[this.option.event_duration], this.page_show_status = !1, this.page_hidden_status = !0, this.isCollectUrl(this.url) && this.sd.track(this.option.event_name_leave, Object.assign(e, this.option.urlPropertyMap(this.url))), this.refreshPageEndTimer(), this.delHeartBeatData();
  }
  ...
  this.addPageStartListener(), this.addPageSwitchListener(), this.addSinglePageListener(), this.addPageEndListener();
}, Y.prototype.addPageStartListener = function() {
  let e = this;
  "onpageshow" in window && this._.addEvent(window, "pageshow", () => {
    e.pageStartHandler(), e.hiddenStatusHandler();
  });
}, Y.prototype.isCollectUrl = function(e) {
  return typeof this.option.isCollectUrl != "function" || typeof e != "string" || e === "" || this.option.isCollectUrl(e);
}, Y.prototype.addSinglePageListener = function() {
  let e = this;
  this.sd.ee && this.sd.ee.spa.prepend("switch", (t) => {
    t !== location.href && (e.url = t, e.pageEndHandler(), e.stopHeartBeatInterval(), e.current_page_url = e.url, e.pageStartHandler(), e.hiddenStatusHandler(), e.addHeartBeatInterval());
  });
}, Y.prototype.addPageEndListener = function() {
  let e = this;
  this._.each(["pagehide", "beforeunload", "unload"], (t) => {
    `on${t}` in window && e._.addEvent(window, t, () => {
      e.pageEndHandler(), e.stopHeartBeatInterval();
...
}, Y.prototype.addPageSwitchListener = function() {
  let e = this;
  this._.listenPageState({
    visible() {
      e.pageStartHandler(), e.hiddenStatusHandler(), e.addHeartBeatInterval();
...
}, Y.prototype.addHeartBeatInterval = function() {
  this._.localStorage.isSupport() && this.startHeartBeatInterval();
}, Y.prototype.startHeartBeatInterval = function() {
  let e = this;
  this.heartbeat_interval_timer && this.stopHeartBeatInterval();
  let t = !0;
  this.isCollectUrl(this.url) || (t = !1), this.heartbeat_interval_timer = setInterval(() => {
...
}, Y.prototype.stopHeartBeatInterval = function() {
  clearInterval(this.heartbeat_interval_timer), this.heartbeat_interval_timer = null;
}, Y.prototype.saveHeartBeatData = function(e) {
  let t = this.getPageLeaveProperties(), r = /* @__PURE__ */ new Date();
  t.$time = r, e === "is_first_heartbeat" && (t[this.option.event_duration] = 3.14);
  let i = this.sd.kit.buildData({
    type: "track",
  ...
  i.heartbeat_interval_time = this.heartbeat_interval_time, this.sd.store.saveObjectVal(`${this.storage_name}-${this.page_id}`, i);
}, Y.prototype.delHeartBeatData = function(e) {
  this._.localStorage.isSupport() && this._.localStorage.remove(e || `${this.storage_name}-${this.page_id}`);
}, Y.prototype.reissueHeartBeatData = function() {
  for (let e = window.localStorage.length - 1; e >= 0; e--) {
    let t = window.localStorage.key(e);
    if (t && t !== `${this.storage_name}-${this.page_id}` && t.indexOf(`${this.storage_name}-`) === 0) {
      let r = this.sd.store.readObjectVal(t);
...
}, Y.prototype.getPageLeaveProperties = function() {
  let e = (+/* @__PURE__ */ new Date() - this.start_time) / 1e3;
  (isNaN(e) || e < 0 || e > this.max_duration) && (e = 0), e = Number(e.toFixed(3));
  let t = this._.getReferrer(this.current_page_url), r = document.documentElement && document.documentElement.scrollTop || window.pageYOffset || document.body && document.body.scrollTop || 0;
  r = Math.round(r) || 0;
...
let xi = !1, Cl = {
  init(e, t) {
    function r() {
      ...
      xi || (e.track("$WebPageLoad", a), xi = !0), window.removeEventListener ? window.removeEventListener("load", r) : window.detachEvent && window.detachEvent("onload", r);
    }
...
Lt.prototype.init = function(e) {
  if (e) {
    ...
    this.log("神策JS SDK未成功引入");
}, Lt.prototype.register = function(e) {
...
function jl(e, t, r) {
  if (e.plugin_name = t, e.init) {
    let i = e.init;
    e.init = function(n, a) {
      if (Nl(n, e, t), n.readyState && n.readyState.state >= 3 || !n.on)
        return l();
      function l() {
        i.call(e, n, a);
      }
...
let wt, oa, It = window.console && window.console.log || function() {
};
function Tl(e) {
  try {
    if (e.event !== "$pageview" && (!e.type || e.type.slice(0, 7) !== "profile")) {
      ...
      e.properties = wt._.extend(e.properties || {}, i);
    }
  } catch {
    It("页面高度获取异常。");
  }
  return oa.call(wt.kit, e);
}
let Ll = {
  init(e) {
    It = (wt = e) && wt.log || It, e && e.kit && e.kit.buildData ? (oa = wt.kit.buildData, wt.kit.buildData = Tl, It(
  ...
  rewriteUrl(e, t) {
    ...
    if (i) {
      let a, l = i[1] || "", u = i[2] || "", p = i[3] || "", b = `_sasdk=${this.getCurrenId()}`, w = function(L) {
        let P = L.split("&"), Se = [];
        return r._.each(P, (J) => {
          J.includes("_sasdk=") ? Se.push(b) : Se.push(J);
        }), Se.join("&");
      };
...
function hu(e) {
  if (e === !0 && dt.isObject(de.para.jsapp) && typeof de.para.jsapp.getData == "function") {
    ...
    dt.isArray(t) && t.length > 0 && dt.each(t, (r) => {
      dt.isJSONString(r) && de.kit.sendData(JSON.parse(r));
    });
  } else
...
function Iu(e, t) {
  ...
  if (et.isObject(e.config) && (r = e.config.send_type, i = et.optimizeServerUrl(e.config.server_url)), (r === "ajax" || !r && Ue.para.send_type === "ajax") && et.isSupportCors()) {
    let n = i || e.server_url;
    e.server_url = n, e.data = Ue.kit.encodeTrackData(e.data), et.isArray(n) && n.length ? et.each(n, (a) => {
      e.callback = null, e.server_url = a, Vi(e);
    }) : typeof n == "string" && n !== "" ? Vi(e) : Ue.log(
      "当前 server_url 为空或不正确，只在控制台打印日志，network 中不会发数据，请配置正确的 server_url！"
    ), t.cancellationToken.stop();
  }
  return e;
...
function xu(e, t) {
  ...
  e.server_url = i, St.isArray(i) && i.length ? St.each(i, (a) => {
    a && (e.data = zi(a, n), e.callback = null, e.server_url = a, Xi(e));
  }) : typeof i == "string" && i !== "" ? (e.data = zi(i, n), Xi(e)) : Oe.logger && Oe.logger.msg(
    "当前 server_url 为空或不正确，只在控制台打印日志，network 中不会发数据，请配置正确的 server_url！"
...
let ie = null, we = null, xt = [], Ku = {
  init(e) {
    e && (we = (ie = e)._, ie.logger && ie.logger.appendWriter(qu), ie.on && ie.on("sdkAfterInitPara", () => {
      for (let t = 0; t < xt.length; t++) la(xt[t]);
      xt = null;
...
function qu(e) {
  xt !== null ? xt.push(e) : la(e);
}
function la(e) {
  try {
    if (e.level === "log" && ua() || e.level === "warn" && Vu() || e.level === "error" && Wu())
      return void Ar(e);
  } catch {
  }
}
...
function Vu() {
  return !!ui() || ua() || we.isObject(ie.para.show_log) && ie.para.show_log.level === "warn";
}
function Wu() {
...
function ui() {
  return we.sessionStorage.isSupport() && sessionStorage.getItem(li) === "true";
}
s.modules = s.modules || {};
for (var Gi = [
  Zi,
  ...
  var vt = Gi[pt];
  s._.isString(vt.plugin_name) ? s.modules[vt.plugin_name] = vt : s._.isArray(vt.plugin_name) && s._.each(vt.plugin_name, (e) => {
    s.modules[e] = vt;
  });
}
for (pt = 0; pt < Qi.length; pt++) s.use(Qi[pt]);
let ca = s;
try {
  typeof window.sensorsDataAnalytic201505 == "string" ? (s.para = window[sensorsDataAnalytic201505].para, s._q = window[sensorsDataAnalytic201505]._q, window[sensorsDataAnalytic201505] = s, window.sensorsDataAnalytic201505 = s, s.init()) : typeof window.sensorsDataAnalytic201505 > "u" ? window.sensorsDataAnalytic201505 = s : ca = window.sensorsDataAnalytic201505;
} catch (e) {
  B(e);
}
let da = ca;
...
class Zu {
  constructor(t, r) {
    return this.sensors = t, this.options = r, this.track = (i, n) => {
      ...
      this.sensors.registerPage(en(i || {}, `${this.options.project}_`));
    }, this.setProfile = (i) => {
      this.sensors.setProfile(en(i || {}, `${this.options.project}_`));
    }, new Proxy(this, {
      get: (i, n, a) => {
        if (Reflect.has(i, n))
