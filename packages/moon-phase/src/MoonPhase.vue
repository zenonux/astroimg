...
function refreshDataNew(process: number) {
  ...
  mDataNew.value[2] = mData.value[6] + (mData.value[2] - mData.value[6]) * process
  ...
  mCtrlNew.value[0] = mCtrl.value[14] + (mCtrl.value[0] - mCtrl.value[14]) * process
  mCtrlNew.value[1] = mCtrl.value[1]
  mCtrlNew.value[2] = mCtrl.value[12] + (mCtrl.value[2] - mCtrl.value[12]) * process
  mCtrlNew.value[3] = mCtrl.value[3]
  mCtrlNew.value[4] = mCtrl.value[10] + (mCtrl.value[4] - mCtrl.value[10]) * process
  mCtrlNew.value[5] = mCtrl.value[5]
  mCtrlNew.value[6] = mCtrl.value[8] + (mCtrl.value[6] - mCtrl.value[8]) * process
...
function drawShadow(process: number, moonOrient: number, isUpMoon: boolean) {
  ...
  withContext(() => {
    ...
    const grad = ctxValue.createLinearGradient(-radius.value, 0, radius.value, 0)
